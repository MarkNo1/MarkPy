...
class TestBaseClass(unittest.TestCase):
    ...
    def test_multiple_initialization_with_params(self):
        base1 = BaseClass(_class_name='BaseClass', _class_version='0.0.1')
        base2 = BaseClass(_class_name='BaseClass', _class_version='0.0.2')
        self.assertEqual(base1._class_name, 'BaseClass')
        self.assertEqual(base1._class_version, '0.0.1')
        self.assertEqual(base1._class_deletion_date, 'nan')

        self.assertEqual(base2._class_name, 'BaseClass')
